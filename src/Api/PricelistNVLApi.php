...
/**
 * PricelistNVLApi Class Doc Comment
 *
 * @category Class
 * @package  Seacommerce\Unit4\Multivers\Sdk
 * @author   OpenAPI Generator team
...
class PricelistNVLApi
{
     ...
     * @return object[]
     */
    public function getPricelistNVL($database)
    {
        list($response) = $this->getPricelistNVLWithHttpInfo($database);
        return $response;
    }

    /**
     * Operation getPricelistNVLWithHttpInfo
     *
     * Gets a name value list of PricelistNVL that matches the specified criteria
     *
     ...
     */
    public function getPricelistNVLWithHttpInfo($database)
    {
        $request = $this->getPricelistNVLRequest($database);
    ...
    /**
     * Operation getPricelistNVLAsync
     *
     * Gets a name value list of PricelistNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     */
    public function getPricelistNVLAsync($database)
    {
        return $this->getPricelistNVLAsyncWithHttpInfo($database)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPricelistNVLAsyncWithHttpInfo
     *
     * Gets a name value list of PricelistNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPricelistNVLAsyncWithHttpInfo($database)
    {
        $returnType = 'object[]';
        $request = $this->getPricelistNVLRequest($database);
    ...
    /**
     * Create request for operation 'getPricelistNVL'
     *
     * @param  string $database (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getPricelistNVLRequest($database)
    {
        // verify the required parameter 'database' is set
        if ($database === null || (is_array($database) && count($database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database when calling getPricelistNVL'
            );
        }

        $resourcePath = '/api/{database}/PricelistNVL';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
