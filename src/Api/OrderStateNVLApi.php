...
/**
 * OrderStateNVLApi Class Doc Comment
 *
 * @category Class
 * @package  Seacommerce\Unit4\Multivers\Sdk
 * @author   OpenAPI Generator team
...
class OrderStateNVLApi
{
     ...
     * @return object[]
     */
    public function getOrderStateNVL($database)
    {
        list($response) = $this->getOrderStateNVLWithHttpInfo($database);
        return $response;
    }

    /**
     * Operation getOrderStateNVLWithHttpInfo
     *
     * Gets a name value list of OrderStateNVL that matches the specified criteria
     *
     ...
     */
    public function getOrderStateNVLWithHttpInfo($database)
    {
        $request = $this->getOrderStateNVLRequest($database);
    ...
    /**
     * Operation getOrderStateNVLAsync
     *
     * Gets a name value list of OrderStateNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     */
    public function getOrderStateNVLAsync($database)
    {
        return $this->getOrderStateNVLAsyncWithHttpInfo($database)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderStateNVLAsyncWithHttpInfo
     *
     * Gets a name value list of OrderStateNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderStateNVLAsyncWithHttpInfo($database)
    {
        $returnType = 'object[]';
        $request = $this->getOrderStateNVLRequest($database);
    ...
    /**
     * Create request for operation 'getOrderStateNVL'
     *
     * @param  string $database (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getOrderStateNVLRequest($database)
    {
        // verify the required parameter 'database' is set
        if ($database === null || (is_array($database) && count($database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database when calling getOrderStateNVL'
            );
        }

        $resourcePath = '/api/{database}/OrderStateNVL';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
