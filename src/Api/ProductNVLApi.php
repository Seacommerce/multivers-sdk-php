...
class ProductNVLApi
{
     ...
     * @return object[]
     */
    public function getProductNVLBy($database)
    {
        list($response) = $this->getProductNVLByWithHttpInfo($database);
        return $response;
    }

    /**
     * Operation getProductNVLByWithHttpInfo
     *
     * Gets a name value list of ProductNVL that matches the specified criteria
     *
     ...
     */
    public function getProductNVLByWithHttpInfo($database)
    {
        $request = $this->getProductNVLByRequest($database);
    ...
    /**
     * Operation getProductNVLByAsync
     *
     * Gets a name value list of ProductNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     */
    public function getProductNVLByAsync($database)
    {
        return $this->getProductNVLByAsyncWithHttpInfo($database)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductNVLByAsyncWithHttpInfo
     *
     * Gets a name value list of ProductNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductNVLByAsyncWithHttpInfo($database)
    {
        $returnType = 'object[]';
        $request = $this->getProductNVLByRequest($database);
    ...
    /**
     * Create request for operation 'getProductNVLBy'
     *
     * @param  string $database (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getProductNVLByRequest($database)
    {
        // verify the required parameter 'database' is set
        if ($database === null || (is_array($database) && count($database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database when calling getProductNVLBy'
            );
        }
