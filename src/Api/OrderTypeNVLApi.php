...
/**
 * OrderTypeNVLApi Class Doc Comment
 *
 * @category Class
 * @package  Seacommerce\Unit4\Multivers\Sdk
 * @author   OpenAPI Generator team
...
class OrderTypeNVLApi
{
     ...
     * @return object[]
     */
    public function getOrderTypeNVL($database)
    {
        list($response) = $this->getOrderTypeNVLWithHttpInfo($database);
        return $response;
    }

    /**
     * Operation getOrderTypeNVLWithHttpInfo
     *
     * Gets a name value list of OrderTypeNVL that matches the specified criteria
     *
     ...
     */
    public function getOrderTypeNVLWithHttpInfo($database)
    {
        $request = $this->getOrderTypeNVLRequest($database);
    ...
    /**
     * Operation getOrderTypeNVLAsync
     *
     * Gets a name value list of OrderTypeNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     */
    public function getOrderTypeNVLAsync($database)
    {
        return $this->getOrderTypeNVLAsyncWithHttpInfo($database)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderTypeNVLAsyncWithHttpInfo
     *
     * Gets a name value list of OrderTypeNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderTypeNVLAsyncWithHttpInfo($database)
    {
        $returnType = 'object[]';
        $request = $this->getOrderTypeNVLRequest($database);
    ...
    /**
     * Create request for operation 'getOrderTypeNVL'
     *
     * @param  string $database (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getOrderTypeNVLRequest($database)
    {
        // verify the required parameter 'database' is set
        if ($database === null || (is_array($database) && count($database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database when calling getOrderTypeNVL'
            );
        }

        $resourcePath = '/api/{database}/OrderTypeNVL';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
