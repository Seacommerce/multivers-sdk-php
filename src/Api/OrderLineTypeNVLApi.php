...
/**
 * OrderLineTypeNVLApi Class Doc Comment
 *
 * @category Class
 * @package  Seacommerce\Unit4\Multivers\Sdk
 * @author   OpenAPI Generator team
...
class OrderLineTypeNVLApi
{
     ...
     * @return object[]
     */
    public function getOrderLineTypeNVL($database)
    {
        list($response) = $this->getOrderLineTypeNVLWithHttpInfo($database);
        return $response;
    }

    /**
     * Operation getOrderLineTypeNVLWithHttpInfo
     *
     * Gets a name value list of OrderLineTypeNVL that matches the specified criteria
     *
     ...
     */
    public function getOrderLineTypeNVLWithHttpInfo($database)
    {
        $request = $this->getOrderLineTypeNVLRequest($database);
    ...
    /**
     * Operation getOrderLineTypeNVLAsync
     *
     * Gets a name value list of OrderLineTypeNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     */
    public function getOrderLineTypeNVLAsync($database)
    {
        return $this->getOrderLineTypeNVLAsyncWithHttpInfo($database)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderLineTypeNVLAsyncWithHttpInfo
     *
     * Gets a name value list of OrderLineTypeNVL that matches the specified criteria
     *
     * @param  string $database (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderLineTypeNVLAsyncWithHttpInfo($database)
    {
        $returnType = 'object[]';
        $request = $this->getOrderLineTypeNVLRequest($database);
    ...
    /**
     * Create request for operation 'getOrderLineTypeNVL'
     *
     * @param  string $database (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getOrderLineTypeNVLRequest($database)
    {
        // verify the required parameter 'database' is set
        if ($database === null || (is_array($database) && count($database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database when calling getOrderLineTypeNVL'
            );
        }

        $resourcePath = '/api/{database}/OrderLineTypeNVL';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
