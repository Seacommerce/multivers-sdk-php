...
class CustomFieldDefinitionInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPIFormats = [
        'allowedValues' => null,
        'appliedToEntity' => 'int32',
        'constraintEntity' => 'int32',
        'constraints' => null,
        'digitsAfterSeperator' => 'int32',
        'digitsBeforeSeperator' => 'int32',
        'entity' => 'int32',
        'groupName' => null,
        'isRequired' => null,
        'length' => 'int32',
     ...
     *
     * @param int|null $appliedToEntity appliedToEntity
     *
     * @return $this
     */
     ...
     *
     * @param int|null $constraintEntity constraintEntity
     *
     * @return $this
     */
