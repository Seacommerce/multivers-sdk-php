...
/**
 * CustomTableInfoListApi Class Doc Comment
 *
 * @category Class
 * @package  Seacommerce\Unit4\Multivers\Sdk
 * @author   OpenAPI Generator team
...
class CustomTableInfoListApi
{
     ...
     */
    public function getCustomTableInfoList($database, $select = null, $filter = null, $orderby = null, $top = null, $skip = null, $expand = null)
    {
        list($response) = $this->getCustomTableInfoListWithHttpInfo($database, $select, $filter, $orderby, $top, $skip, $expand);
        return $response;
    }
     ...
     */
    public function getCustomTableInfoListWithHttpInfo($database, $select = null, $filter = null, $orderby = null, $top = null, $skip = null, $expand = null)
    {
        $request = $this->getCustomTableInfoListRequest($database, $select, $filter, $orderby, $top, $skip, $expand);
     ...
     */
    public function getCustomTableInfoListAsync($database, $select = null, $filter = null, $orderby = null, $top = null, $skip = null, $expand = null)
    {
        return $this->getCustomTableInfoListAsyncWithHttpInfo($database, $select, $filter, $orderby, $top, $skip, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomTableInfoListAsyncWithHttpInfo($database, $select = null, $filter = null, $orderby = null, $top = null, $skip = null, $expand = null)
    {
        $returnType = '\Seacommerce\Unit4\Multivers\Sdk\Model\CustomTable[]';
        $request = $this->getCustomTableInfoListRequest($database, $select, $filter, $orderby, $top, $skip, $expand);
     ...
     */
    protected function getCustomTableInfoListRequest($database, $select = null, $filter = null, $orderby = null, $top = null, $skip = null, $expand = null)
    {
        ...
        $resourcePath = '/api/{database}/CustomTableInfoList';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
