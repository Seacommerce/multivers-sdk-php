<?php
/**
 * ProductDiscountGroupNVLApiTest
 * PHP version 5
 *
 * @category Class
...
/**
 * ProductDiscountGroupNVLApiTest Class Doc Comment
 *
 * @category Class
 * @package  Seacommerce\Unit4\Multivers\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ProductDiscountGroupNVLApiTest extends TestCase
{
    ...
    /**
     * Test case for getProductDiscountGroupNVL
     *
     * Gets a name value list of ProductDiscountGroupNVL that matches the specified criteria.
     *
     */
    public function testGetProductDiscountGroupNVL()
    {
    }
}
