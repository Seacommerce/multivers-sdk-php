...
class ProductGroupApi
{
     ...
     * @return void
     */
    public function deleteProductGroup($database, $productGroupId)
    {
        $this->deleteProductGroupWithHttpInfo($database, $productGroupId);
    }
     ...
     */
    public function deleteProductGroupWithHttpInfo($database, $productGroupId)
    {
        $request = $this->deleteProductGroupRequest($database, $productGroupId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteProductGroupAsync($database, $productGroupId)
    {
        return $this->deleteProductGroupAsyncWithHttpInfo($database, $productGroupId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteProductGroupAsyncWithHttpInfo($database, $productGroupId)
    {
        $returnType = '';
        $request = $this->deleteProductGroupRequest($database, $productGroupId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteProductGroupRequest($database, $productGroupId)
    {
        // verify the required parameter 'database' is set
        if ($database === null || (is_array($database) && count($database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database when calling deleteProductGroup'
            );
        }
        // verify the required parameter 'productGroupId' is set
        if ($productGroupId === null || (is_array($productGroupId) && count($productGroupId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $productGroupId when calling deleteProductGroup'
            );
        }

        $resourcePath = '/api/{database}/ProductGroup/{productGroupId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($productGroupId !== null) {
            $resourcePath = str_replace(
                '{' . 'productGroupId' . '}',
                ObjectSerializer::toPathValue($productGroupId),
                $resourcePath
            );
        }
     ...
     * @return \Seacommerce\Unit4\Multivers\Sdk\Model\ProductGroup
     */
    public function getProductGroup($database, $productGroupId)
    {
        list($response) = $this->getProductGroupWithHttpInfo($database, $productGroupId);
        return $response;
    }
     ...
     * @return array of \Seacommerce\Unit4\Multivers\Sdk\Model\ProductGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductGroupWithHttpInfo($database, $productGroupId)
    {
        $request = $this->getProductGroupRequest($database, $productGroupId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductGroupAsync($database, $productGroupId)
    {
        return $this->getProductGroupAsyncWithHttpInfo($database, $productGroupId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductGroupAsyncWithHttpInfo($database, $productGroupId)
    {
        $returnType = '\Seacommerce\Unit4\Multivers\Sdk\Model\ProductGroup';
        $request = $this->getProductGroupRequest($database, $productGroupId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductGroupRequest($database, $productGroupId)
    {
        // verify the required parameter 'database' is set
        if ($database === null || (is_array($database) && count($database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database when calling getProductGroup'
            );
        }
        // verify the required parameter 'productGroupId' is set
        if ($productGroupId === null || (is_array($productGroupId) && count($productGroupId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $productGroupId when calling getProductGroup'
            );
        }
