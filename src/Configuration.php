...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sandbox.api.online.unit4.nl/v110';
    ...
    {
        $report  = 'PHP SDK (Seacommerce\Unit4\Multivers\Sdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.10.0' . PHP_EOL;
        $report .= '    SDK Package Version: 110.0.0' . PHP_EOL;
